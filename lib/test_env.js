...
exports.init = function (options, callback) {
   ...
   */
  browser.waitFor = global.waitFor = function (selectors, timeout) {
    timeout = timeout || 200;
   ...
   */
  browser.find = global.find = function (selector, timeout) {
   ...
   */
  browser.findAll = global.findAll = function (selector, timeout) {
    browser.waitFor(selector, timeout);
   ...
   * @return {Number}
   */
  browser.count = global.count = function (selector) {
   ...
   */
  browser.wait = global.wait = function (timeout) {
    Fiber(function () {
      var fut = new Future;
      setTimeout(function () {
        fut.return(1);
