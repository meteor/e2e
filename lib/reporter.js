...
// exposed flag indicating whether to log error stacks.
// by default this is false because huge stacks makes the logged output hard
// to parse visually.
exports.logError = false;
...
exports.reportError = function (browser, line) {
  if (! exports.logStack && line.slice(0, 5) !== 'Error')
    return;
  log(browser, red(line));
};
